...
class TestMultiplication:
    ...
    def test_multiplication_over_negative_numbers_case(self):
        assert multiplication_over_negative_numbers_case == float(self.test_cases_list[5])

    def test_negative_number_result_multiplication_case(self):
        assert negative_number_result_multiplication_case == float(self.test_cases_list[6])

    def test_negative_number_calculating_multiplication_case(self):
        assert negative_number_calculating_multiplication_case == float(self.test_cases_list[7])
