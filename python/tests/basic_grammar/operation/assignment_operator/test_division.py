from basic_grammar.operation.assignment_operator.division import \
    division_assignment_operator, \
    decimal_division_assignment_operator, \
    negative_division_assignment_operator
from tests.get_file_path import get_file_path


class TestDivisionAssignmentOperator:
    @classmethod
    def setup_class(cls):
